...
export default function UserRating() {
  ...
  return (
    <div className={styles.ratings_wrapper}>
      <button onClick={handleMinusClick} className= {styles.button}>-</button>
      {/* Mapping over an array witgh count num
      of slots and render a span with an HTML heart for each */}
      <div className= {styles.heart_frame}>
      ...
      <button onClick={handlePlusClick} className = {styles.button}>+</button>
    </div>
  )
}